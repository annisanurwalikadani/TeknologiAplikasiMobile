    ...
    public void onClick(View v){
        switch (v.getId()){
            ...
            case R.id.btn_move_activity_data:
                Intent moveWithDataIntent = new Intent(MainActivity.this, MoveDataWithActivity.class);
                moveWithDataIntent.putExtra(MoveDataWithActivity.EXTRA_NAME, "Annisa Nurwalikadani");
                moveWithDataIntent.putExtra(MoveDataWithActivity.EXTRA_AGE, 20);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Nurwalikadani");
                mPerson.setAge(20);
                mPerson.setEmail("annisanurwalikadani@gmail.com");
                mPerson.setCity("Manado");
                Intent moveWithObjectIntent = new Intent (MainActivity.this, MoveWithObjectActivity.class);
                moveWithObjectIntent.putExtra(MoveWithObjectActivity.EXTRA_PERSON, mPerson);
                startActivity(moveWithObjectIntent);
            case R.id.btn_dial_number:
                String phoneNumber = "085712345678";
